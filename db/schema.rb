...
ActiveRecord::Schema[7.1].define(version: 2024_01_27_003702) do
  ...
  add_foreign_key "event_attendees", "events", column: "event_attendee_id"
  add_foreign_key "event_attendees", "users", column: "attended_event_id"
